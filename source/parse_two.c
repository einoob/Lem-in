...
/*   Updated: 2020/07/24 14:47:14 by elindber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		add_link(t_info *info, char *line, int i)
{
	...
	if ((ft_strequ(link_data[0], info->start) && ft_strequ(link_data[1], info->end))
	|| (ft_strequ(link_data[0], info->end) && ft_strequ(link_data[1], info->start)))
